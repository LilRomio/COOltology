...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <p>Updated at July 2nd, 2024</p>
      <br />
      <p>
        {' '}
        cooltology (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your
        personal information is collected, used, and disclosed by cooltology.
      </p>
      <br />
      <p>
        This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
        alongside our application, cooltology. By accessing or using our Service, you signify that you have read,
      ...
      <ul>
        ...
        <li>
          Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to cooltology, that is
          responsible for your information under this Privacy Policy.
        </li>
        <li>Country: where cooltology or the owners/founders of cooltology are based, in this case is Romania</li>
        <li>
          Customer: refers to the company, organization or person that signs up to use the cooltology Service to manage
        ...
        <li>
          ...
          to visit cooltology and use the services.
        </li>
        <li>
        ...
        <li>
          Personnel: refers to those individuals who are employed by cooltology or are under contract to perform a
        ...
        <li>
          Service: refers to the service provided by cooltology as described in the relative terms (if available) and on
          this platform.{' '}
        </li>
        <li>
        ...
        <li>Website: cooltology’s site, which can be accessed via this URL: www.cooltology.com</li>
        <li>You: a person or entity that is registered with cooltology to use the Services.</li>
      </ul>
      <br />
      <br />
      ...
      <p>
        ...
        is collected automatically when you visit our platform. This information may be used to connect your computer to
        ...
        Uniform Resource Locator (URL) clickstream to, through and from our website that may include date and time;
        cookie number; parts of the site you viewed or searched for; and the phone number you used to call our Customer
        Services. We may also use browser data such as cookies, Flash cookies (also known as Flash Local Shared Objects)
        or similar data on certain parts of our website for fraud prevention and other purposes. During your visits, we
        may use software tools such as JavaScript to measure and collect session information including page response
      ...
      <br />
      <p>
        We automatically collect certain information when you visit, use or navigate the platform. This information does
      ...
      <p>
        ...
        of all or substantially all of the assets of cooltology or any of its Corporate Affiliates (as defined herein),
        or that portion of cooltology or any of its Corporate Affiliates to which the Service relates, or in the event
      ...
      <p>
        ...
        is controlled by or is under common control with cooltology, whether by ownership or otherwise. Any information
      ...
      <br />
      <p>
        The laws of Romania, excluding its conflicts of law rules, shall govern this Agreement and your use of the
        website. Your use of the website may also be subject to other local, state, national, or international laws.
      </p>
      <br />
      <p>
        By using cooltology or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not
      ...
      <p>
        ...
        our site and how it's being used. By using our cooltology, registering an account, or making a purchase, you
      ...
      <p>
        ...
        or controlled by cooltology. We are not responsible for the content, accuracy or opinions expressed in such
      ...
      <h2>Cookies</h2>
      <p>
        cooltology uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece
        of data stored on your computer or mobile device by your web browser. We use Cookies to enhance the performance
        and functionality of our website but are non-essential to their use. However, without these cookies, certain
        functionality like videos may become unavailable or you would be required to enter your login details every time
        you visit the website as we would not be able to remember that you had logged in previously. Most web browsers
      ...
      <p>
        ...
        guardian and You are aware that Your child has provided Us with Personal Data without your permission, please
        contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13 without
      ...
      <br />
      <p>
        You acknowledge and agree that cooltology shall not be responsible for any Third-Party Services, including their
        accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other
        aspect thereof. cooltology does not assume and shall not have any liability or responsibility to you or any
      ...
      <p>
        ...
        Our customers’ data is important irrespective of where they are located, which is why we have implemented GDPR
      ...
      <p>
        ...
        fines for breach. Beyond these facts it's simply the right thing to do. At cooltology we strongly believe that
      ...
      <p>
        We are committed to helping our customers meet the data subject rights requirements of GDPR. cooltology
      ...
      <br />
      <ul>
        <li>Via Email: sandra@cooltology.com</li>
        <li>Via Phone Number: +40720880348</li>{' '}
      </ul>
    </div>
  );
};
